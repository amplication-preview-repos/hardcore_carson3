...
import { TradeSettingsTitle } from "../tradeSettings/TradeSettingsTitle";
  ...
  return (
    <Edit {...props}>
      <SimpleForm>
        ...
        <ReferenceArrayInput
          source="tradeSettingsItems"
          reference="TradeSettings"
          parse={(value: any) => value && value.map((v: any) => ({ id: v }))}
          format={(value: any) => value && value.map((v: any) => v.id)}
        >
          <SelectArrayInput optionText={TradeSettingsTitle} />
        </ReferenceArrayInput>
